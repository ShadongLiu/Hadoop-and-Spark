...
object TrendingArrivals {
  ...
  def stateMap(batchTime: Time, key: String, newValue: Option[Int], state: State[Tuple3[Int, Long, Int]]): Option[(String, Tuple3[Int, Long, Int])] = {
    val current = newValue.getOrElse(0).toInt
